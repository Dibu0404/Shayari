...
public class Sad extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#393737")));
        ...
        relativeLayout.setBackground(getDrawable(R.drawable.sad));
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Sad");
