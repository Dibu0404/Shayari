...
public class Motivational extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setTitle("Motivational");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#033207")));
        ...
        relativeLayout.setBackground(getDrawable(R.drawable.motivational));
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Motivational");
