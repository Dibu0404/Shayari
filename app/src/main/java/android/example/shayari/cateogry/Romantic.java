...
public class Romantic extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setTitle("Romantic");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#F10583")));
        ...
        relativeLayout.setBackground(getDrawable(R.drawable.romantic));
